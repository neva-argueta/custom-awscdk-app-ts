...
Name|Description
----|-----------
[CustomAwsCdkTypeScriptApp](#custom-awscdk-app-ts-customawscdktypescriptapp)|*No description*
...
Name|Description
----|-----------
[CustomAwsCdkTypeScriptAppOptions](#custom-awscdk-app-ts-customawscdktypescriptappoptions)|*No description*



## class CustomAwsCdkTypeScriptApp 🔹 <a id="custom-awscdk-app-ts-customawscdktypescriptapp"></a>
...
* **options** (<code>[CustomAwsCdkTypeScriptAppOptions](#custom-awscdk-app-ts-customawscdktypescriptappoptions)</code>)  *No description*
  ...
  * **husky** (<code>boolean</code>)  *No description* 




## struct CustomAwsCdkTypeScriptAppOptions 🔹 <a id="custom-awscdk-app-ts-customawscdktypescriptappoptions"></a>
...
-----|------|-------------
**cdkVersion**🔹 | <code>string</code> | AWS CDK version to use.
**husky**🔹 | <code>boolean</code> | <span></span>
**name**🔹 | <code>string</code> | This is the name of your package.
